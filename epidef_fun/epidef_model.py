...
def efficientnet():
    ...
    seq = Sequential()
    seq.add(Conv2D(140, (3, 3), padding='same', activation='relu'))
    seq.add(BatchNormalization(axis=-1))
    seq.add(MaxPool2D((2, 2)))
    seq.add(Conv2D(70, (3, 3), padding='same', activation='relu'))
    seq.add(BatchNormalization(axis=-1))
    seq.add(Conv2D(100, (3, 3), padding='same', activation='relu'))
    seq.add(BatchNormalization(axis=-1))
    seq.add(Conv2D(100, (3, 3), padding='same', activation='relu'))
    seq.add(BatchNormalization(axis=-1))
    seq.add(MaxPool2D((2, 2)))
    ...
    seq.add(BatchNormalization(axis=-1))
    seq.add(MaxPool2D((2, 2)))
    seq.add(Conv2D(280, (3, 3), padding='same', activation='relu'))
    seq.add(BatchNormalization(axis=-1))
    seq.add(Conv2D(280, (3, 3), padding='same', activation='relu'))
    seq.add(BatchNormalization(axis=-1))
    seq.add(Conv2D(280, (3, 3), padding='same', activation='relu'))
    ...
    seq.add(Conv2D(280, (3, 3), padding='same', activation='relu'))
    seq.add(BatchNormalization(axis=-1))
    seq.add(Conv2D(360, (3, 3), padding='same', activation='relu'))
    seq.add(BatchNormalization(axis=-1))
    seq.add(Conv2D(360, (3, 3), padding='same', activation='relu'))
    seq.add(BatchNormalization(axis=-1))
    seq.add(Conv2D(360, (3, 3), padding='same', activation='relu'))
    seq.add(BatchNormalization(axis=-1))
    seq.add(MaxPool2D((2, 2)))
    seq.add(Conv2D(600, (3, 3), padding='same', activation='relu'))
    seq.add(BatchNormalization(axis=-1))
    seq.add(Flatten())
